...
namespace UnityEditor
{
    /// <summary>
    /// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    /// This class is copy from RuleTile, DO NOT use this.
    /// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    /// 
    /// The Editor for a KoyouRuleTile.
    /// </summary>
    [CustomEditor(typeof(KoyouRuleTile), true)]
    [CanEditMultipleObjects]
    public class KoyouRuleTileEditor : Editor
    {
        ...
        private static readonly string k_UndoName = L10n.Tr("Change KoyouRuleTile");
        ...
        private static class Styles
        {
            ...
            public static readonly GUIContent emptyKoyouRuleTileInfo =
        ...
        /// <summary>
        /// The KoyouRuleTile being edited
        /// </summary>
        public KoyouRuleTile tile => target as KoyouRuleTile;
        ...
        /// <summary>
        /// Whether the KoyouRuleTile can extend its neighbors beyond directly adjacent ones
        /// </summary>
        ...
        /// <summary>
        /// OnEnable for the KoyouRuleTileEditor
        /// </summary>
        public virtual void OnEnable()
        {
            m_ReorderableList = new ReorderableList(tile != null ? tile.m_TilingRules : null, typeof(KoyouRuleTile.TilingRule), true, true, true, true);
        ...
        /// <summary>
        /// OnDisable for the KoyouRuleTileEditor
        /// </summary>
        ...
        public virtual BoundsInt GetRuleGUIBounds(BoundsInt bounds, KoyouRuleTile.TilingRule rule)
        {
            if (extendNeighbor)
            {
                bounds.xMin--;
        ...
        {
            KoyouRuleTile.TilingRule rule = tile.m_TilingRules[index];
        ...
        public float GetElementHeight(KoyouRuleTile.TilingRule rule)
        {
            BoundsInt bounds = GetRuleGUIBounds(rule.GetBounds(), rule);

            float inspectorHeight = GetElementHeight(rule as KoyouRuleTile.TilingRuleOutput);
        ...
        public float GetElementHeight(KoyouRuleTile.TilingRuleOutput rule)
        {
            float inspectorHeight = k_DefaultElementHeight + k_PaddingBetweenRules;

            switch (rule.m_Output)
            {
                case KoyouRuleTile.TilingRuleOutput.OutputSprite.Random:
                case KoyouRuleTile.TilingRuleOutput.OutputSprite.Animation:
        ...
        /// <summary>
        /// Gets the GUI matrix size for a Rule of a KoyouRuleTile
        /// </summary>
        /// <param name="bounds">Cell bounds of the Rule.</param>
        /// <returns>Returns the GUI matrix size for a Rule of a KoyouRuleTile.</returns>
        ...
        private void OnAddElement(object obj)
        {
            ...
            KoyouRuleTile.TilingRule rule = new KoyouRuleTile.TilingRule();
            rule.m_Output = KoyouRuleTile.TilingRuleOutput.OutputSprite.Single;
            ...
            ResizeKoyouRuleTileList(count + 1);
        ...
        /// <summary>
        /// Saves any changes to the KoyouRuleTile
        /// </summary>
        ...
        /// </summary>
        /// <param name="target">KoyouRuleTile which has been updated</param>
        public static void UpdateAffectedOverrideTiles(KoyouRuleTile target)
        {
        ...
        /// <summary>
        /// Gets all RuleOverrideTiles which override the given KoyouRuleTile
        /// </summary>
        /// <param name="target">KoyouRuleTile which has been updated</param>
        /// <returns>A list of RuleOverrideTiles which override the given KoyouRuleTile</returns>
        public static List<RuleOverrideTile> FindAffectedOverrideTiles(KoyouRuleTile target)
        {
        ...
        /// <summary>
        /// Draws the Inspector GUI for the KoyouRuleTileEditor
        /// </summary>
        public override void OnInspectorGUI()
        {
            ...
            if (count == 0)
            {
                ...
                DisplayClipboardText(Styles.emptyKoyouRuleTileInfo, rect);
        ...
        private void ResizeKoyouRuleTileList(int count)
        {
            ...
            if (isEmpty)
            {
                for (int i = 0; i < count; ++i)
                    tile.m_TilingRules[i] = new KoyouRuleTile.TilingRule();
            }
        ...
        /// <summary>
        /// Draw editor fields for custom properties for the KoyouRuleTile
        /// </summary>
        ...
        /// <summary>
        /// Gets the index for a Rule with the KoyouRuleTile to display an arrow.
        /// </summary>
        /// <param name="position">The relative position of the arrow from the center.</param>
        /// <returns>Returns the index for a Rule with the KoyouRuleTile to display an arrow.</returns>
        ...
        public virtual void RuleOnGUI(Rect rect, Vector3Int position, int neighbor)
        {
            switch (neighbor)
            {
                case KoyouRuleTile.TilingRuleOutput.Neighbor.This:
                    GUI.DrawTexture(rect, arrows[GetArrowIndex(position)]);
                    break;
                case KoyouRuleTile.TilingRuleOutput.Neighbor.NotThis:
        ...
        public virtual void RuleTransformOnGUI(Rect rect, KoyouRuleTile.TilingRuleOutput.Transform ruleTransform)
        {
            switch (ruleTransform)
            {
                case KoyouRuleTile.TilingRuleOutput.Transform.Rotated:
                    GUI.DrawTexture(rect, autoTransforms[0]);
                    break;
                case KoyouRuleTile.TilingRuleOutput.Transform.MirrorX:
                    GUI.DrawTexture(rect, autoTransforms[1]);
                    break;
                case KoyouRuleTile.TilingRuleOutput.Transform.MirrorY:
                    GUI.DrawTexture(rect, autoTransforms[2]);
                    break;
                case KoyouRuleTile.TilingRuleOutput.Transform.Fixed:
                    GUI.DrawTexture(rect, autoTransforms[3]);
                    break;
                case KoyouRuleTile.TilingRuleOutput.Transform.MirrorXY:
        ...
        public void RuleNeighborUpdate(Rect rect, KoyouRuleTile.TilingRule tilingRule, Dictionary<Vector3Int, int> neighbors, Vector3Int position)
        {
        ...
        public void RuleTransformUpdate(Rect rect, KoyouRuleTile.TilingRule tilingRule)
        {
            if (Event.current.type == EventType.MouseDown && ContainsMousePosition(rect))
            {
                tilingRule.m_RuleTransform = (KoyouRuleTile.TilingRuleOutput.Transform) (int) Mathf.Repeat((int) tilingRule.m_RuleTransform + GetMouseChange(), Enum.GetValues(typeof(KoyouRuleTile.TilingRule.Transform)).Length);
                GUI.changed = true;
                Event.current.Use();
            }
        }
        ...
        /// <summary>
        /// Draws a Rule Matrix for the given Rule for a KoyouRuleTile.
        /// </summary>
        ...
        public virtual void RuleMatrixOnGUI(KoyouRuleTile tile, Rect rect, BoundsInt bounds, KoyouRuleTile.TilingRule tilingRule)
        {
        ...
        /// <summary>
        /// Draws a Rule Matrix Icon for the given matching Rule for a KoyouRuleTile with the given position
        /// </summary>
        /// <param name="tilingRule">Tile to draw rule for.</param>
        /// <param name="neighbors">A dictionary of neighbors</param>
        /// <param name="position">The relative position of the neighbor matching Rule</param>
        /// <param name="rect">GUI Rect to draw icon at</param>
        public void RuleMatrixIconOnGUI(KoyouRuleTile.TilingRule tilingRule, Dictionary<Vector3Int, int> neighbors, Vector3Int position, Rect rect)
        {
        ...
        public virtual void SpriteOnGUI(Rect rect, KoyouRuleTile.TilingRuleOutput tilingRule)
        {
        ...
        public void RuleInspectorOnGUI(Rect rect, KoyouRuleTile.TilingRuleOutput tilingRule)
        {
            float y = rect.yMin;
            ...
            tilingRule.m_Output = (KoyouRuleTile.TilingRuleOutput.OutputSprite) EditorGUI.EnumPopup(new Rect(rect.xMin + k_LabelWidth, y, rect.width - k_LabelWidth, k_SingleLineHeight), tilingRule.m_Output);
            y += k_SingleLineHeight;

            if (tilingRule.m_Output == KoyouRuleTile.TilingRuleOutput.OutputSprite.Animation)
            {
            ...
            if (tilingRule.m_Output == KoyouRuleTile.TilingRuleOutput.OutputSprite.Random)
            {
                ...
                tilingRule.m_RandomTransform = (KoyouRuleTile.TilingRuleOutput.Transform) EditorGUI.EnumPopup(new Rect(rect.xMin + k_LabelWidth, y, rect.width - k_LabelWidth, k_SingleLineHeight), tilingRule.m_RandomTransform);
                y += k_SingleLineHeight;
            }

            if (tilingRule.m_Output != KoyouRuleTile.TilingRuleOutput.OutputSprite.Single)
            {
                GUI.Label(new Rect(rect.xMin, y, k_LabelWidth, k_SingleLineHeight)
                    , tilingRule.m_Output == KoyouRuleTile.TilingRuleOutput.OutputSprite.Animation ? Styles.tilingRulesAnimationSize : Styles.tilingRulesRandomSize);
                EditorGUI.BeginChangeCheck();
        ...
        private void HandleDragAndDrop(Rect guiRect)
        {
            ...
            switch (Event.current.type)
            {
                ...
                case EventType.DragPerform:
                {
                    ...
                    ResizeKoyouRuleTileList(dragAndDropSprites.Count);
        ...
        /// <summary>
        /// Whether the KoyouRuleTile has a preview GUI
        /// </summary>
        ...
        /// <summary>
        /// Draws the preview GUI for the KoyouRuleTile
        /// </summary>
        ...
        /// <summary>
        /// Creates a Preview for the KoyouRuleTile.
        /// </summary>
        ...
        /// <summary>
        /// Renders a static preview Texture2D for a KoyouRuleTile asset
        /// </summary>
        /// <param name="assetPath">Asset path of the KoyouRuleTile</param>
        ...
        /// <returns>Texture2D containing static preview for the KoyouRuleTile asset</returns>
        ...
        /// </summary>
        [Serializable]
        class KoyouRuleTileRuleWrapper
        {
            /// <summary>
            /// List of Rules to serialize
            /// </summary>
            [SerializeField] public List<KoyouRuleTile.TilingRule> rules = new List<KoyouRuleTile.TilingRule>();
        }

        /// <summary>
        /// Copies all Rules from a KoyouRuleTile to the clipboard
        /// </summary>
        /// <param name="item">MenuCommand storing the KoyouRuleTile to copy from</param>
        [MenuItem("CONTEXT/KoyouRuleTile/Copy All Rules")]
        public static void CopyAllRules(MenuCommand item)
        {
            KoyouRuleTile tile = item.context as KoyouRuleTile;
            if (tile == null)
                return;

            KoyouRuleTileRuleWrapper rulesWrapper = new KoyouRuleTileRuleWrapper();
        ...
        /// <summary>
        /// Pastes all Rules from the clipboard to a KoyouRuleTile
        /// </summary>
        /// <param name="item">MenuCommand storing the KoyouRuleTile to paste to</param>
        [MenuItem("CONTEXT/KoyouRuleTile/Paste Rules")]
