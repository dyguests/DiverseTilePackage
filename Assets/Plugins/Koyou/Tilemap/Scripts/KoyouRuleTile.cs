...
namespace Koyou
{
    ...
    public class KoyouRuleTile<T> : KoyouRuleTile
    {
        /// <summary>
    ...
    /// </summary>
    [Serializable]
    [HelpURL("https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@latest/index.html?subfolder=/manual/KoyouRuleTile.html")]
    public class KoyouRuleTile : TileBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Angle in which the KoyouRuleTile is rotated by for matching in Degrees.
        /// </summary>
        public virtual int m_RotationAngle => 90;

        /// <summary>
        /// Number of rotations the KoyouRuleTile can be rotated by for matching.
        /// </summary>
        ...
        public class TilingRule : TilingRuleOutput
        {
            ...
            /// <summary>
            /// * Preset this list to KoyouRuleTile backward compatible, but not support for HexagonalKoyouRuleTile backward compatible.
            /// </summary>
        ...
        /// <summary>
        /// Returns a set of neighboring positions for this KoyouRuleTile
        /// </summary>
        ...
        /// <summary>
        /// Updates the neighboring positions of this KoyouRuleTile
        /// </summary>
        ...
        static KeyValuePair<HashSet<TileBase>, HashSet<Vector3Int>> CachingTilemapNeighborPositions(Tilemap tilemap)
        {
            ...
            for (int i = 0; i < usedTileCount; i++)
            {
                ...
                usedTiles.Add(tile);
                KoyouRuleTile ruleTile = null;

                if (tile is KoyouRuleTile rt)
                    ruleTile = rt;
                // # MODIFY by dyguests
        ...
        public override void RefreshTile(Vector3Int position, ITilemap tilemap)
        {
            ...
            var neighborPositionsKoyouRuleTile = neighborPositionsSet.Value;
            foreach (Vector3Int offset in neighborPositionsKoyouRuleTile)
            {
        ...
        /// <summary>
        /// Returns custom fields for this KoyouRuleTile
        /// </summary>
        /// <param name="isOverrideInstance">Whether override fields are returned</param>
        /// <returns>Custom fields for this KoyouRuleTile</returns>
        public FieldInfo[] GetCustomFields(bool isOverrideInstance)
        {
            return this.GetType().GetFields(BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic)
                .Where(field => typeof(KoyouRuleTile).GetField(field.Name) == null)
